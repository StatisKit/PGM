...
void wrapper_1fc8561b7ba15d09b84ce310923332b3()
{
    ...
    class ::std::vector< unsigned long int, class ::std::allocator< unsigned long int > >  (*function_pointer_1fc8561b7ba15d09b84ce310923332b3)(class ::std::vector< unsigned long int, class ::std::allocator< unsigned long int > > const &) = ::statiskit::pgm::ordering_to_rank;
    boost::python::def("ordering_to_rank", function_pointer_1fc8561b7ba15d09b84ce310923332b3, "");
}